...
namespace ArrowShop
{
    ...
    public class ArrowParts
    {
        ...
        {
            string msg = "";
            msg = msg + " Arrow Head Cost   " + this.arrowhead + ".00 Gold \n";
            msg = msg + " Fletching Cost    " + this.fletching + ".00 Gold \n";
            msg = msg + " Shaft Cost         " + Math.Round(this.shaft) + ".00 Gold \n";
            msg = msg + " Tax                1.00 Gold\n";
            msg = msg + "-----------------------------------------\n";
            msg = msg + " Total Cost        " + this.price + ".00 Gold \n";
        ...
        public ArrowParts(string aName,int aarrowhead, int afletching, double ashaft)
        {
            while (true)
            {
                Console.Write(" Name: "); aName = Console.ReadLine();
                Console.WriteLine(" ");
                ...
                if (aName != ""&& aName!=" ")
                {
                    ...
                    Console.WriteLine(" Welcome to the shop " + aName);
                    Console.WriteLine("\n");
                    break;
            ...
            // taking the value and calculating in the Price Section
                this.price = Math.Round(ArrowHead + Fletching + Shaft+1);
